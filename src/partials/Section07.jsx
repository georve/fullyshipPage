...
import Pricing01 from '../images/pricing-01.png';
import Pricing02 from '../images/pricing-02.png';
import Pricing03 from '../images/pricing-03.png';
import Pricing04 from '../images/pricing-04.png';
              ...
              >
                ...
                <div className="relative flex flex-col h-full rounded-br-[100px] py-5 px-6">
                  <div className="mb-4">
                    ...
                    <img className="w-full rounded-lg" src={Pricing01} width="210" height="124" alt="Starter" />
                  </div>
                  <div className="mb-5">
                ...
                <div className="relative flex flex-col h-full bg-gradient-to-b from-blue-100 to-blue-50 rounded-br-[100px] py-5 px-6">
                  ...
                  <div className="mb-4">
                    ...
                    <img className="w-full rounded-lg" src={Pricing02} width="210" height="124" alt="Smart" />
                  </div>
                  <div className="mb-5">
                ...
                <div className="relative flex flex-col h-full rounded-br-[100px] py-5 px-6">
                  <div className="mb-4">
                    ...
                    <img className="w-full rounded-lg" src={Pricing03} width="210" height="124" alt="You" />
                  </div>
                  <div className="mb-5">
                ...
                <div className="relative flex flex-col h-full rounded-br-[100px] py-5 px-6">
                  <div className="mb-4">
                    ...
                    <img className="w-full rounded-lg" src={Pricing04} width="210" height="124" alt="Black" />
                  </div>
                  <div className="mb-5">
